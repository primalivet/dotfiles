...
^WebResourceURL_WebResourceFrameName_WebResourceData_WebResourceMIMEType_WebResourceTextEncodingName_Nhttps://raw.githubusercontent.com/ionide/Ionide-vim/master/autoload/fsharp.vimPOYÂ<html><head></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">" Vim autoload functions
...
" vim: sw=4 et sts=4
</pre></body></html>Ztext/plainUUTF-8    ( 7 N ` v ” å æZ¬Z·                           Z½