...
nvim_set_keymap("i", "<C-d>", "<Plug>(copilot-dismiss)", default_opt)
nvim_set_keymap("i", "<C-[>", "<Plug>(copilot-previous)", default_opt)
nvim_set_keymap("i", "<C-]>", "<Plug>(copilot-next)", default_opt)
...
nvim_set_keymap("n", "<leader>sh", ":History<CR>", default_opt)
