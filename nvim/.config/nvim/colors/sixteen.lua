...
set_hl(0, "Tag", { ctermfg = bright_magenta })
set_hl(0, "Comment", { ctermfg = cyan, italic = 1 })
set_hl(0, "String", { ctermfg = bright_magenta })
...
-- set_hl(0,"Identifier", { ctermfg = bright_cyan, bold = 1 })
-- set_hl(0, "Statement", { ctermfg = bright_yellow })
-- set_hl(0, "PreProc", { ctermfg = bright_blue })
-- set_hl(0, "Type", { ctermfg = bright_green })
-- reset( "Special")
-- reset("Ignore")
-- set_hl(0, "Underlined", { underline = 1 })
-- set_hl(0, "Error", { ctermfg = red })
