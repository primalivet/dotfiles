...
set_hl(0, "String", { ctermfg = is_dark and bright_green or green })
set_hl(0, "Identifier", { link = "Normal" })
set_hl(0, "Statement", { bold = true })
set_hl(0, "Conditional", { ctermfg = is_dark and bright_yellow or magenta })
set_hl(0, "Repeat", { ctermfg = is_dark and bright_yellow or magenta })
set_hl(0, "Label", { ctermfg = is_dark and bright_yellow or magenta })
set_hl(0, "Operator", {})
set_hl(0, "Keyword", { ctermfg = is_dark and bright_yellow or magenta })
set_hl(0, "Exception", { ctermfg = is_dark and bright_yellow or magenta })
